...
const CONFIG = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "E' una sorpresa....",
      tech: ["Python", "Viewer", "API"],
      demo: "#",
      code: "#"
    },
  ...
  socials: {
    ...
    linkedin: "https://instagram.com/lorenzo.celoria.09",
...
<span class="tok-fn">echo</span> <span class="tok-string">"💼 Instagram: ${CONFIG.socials.linkedin.replace('https://','')}"</span>
<span class="tok-fn">echo</span> <span class="tok-string">"🐙 GitHub:   ${CONFIG.socials.github.replace('https://','')}"</span>

<span class="tok-fn">echo</span> <span class="tok-string">"Contattami quando hai nuovi progeti!✅"</span>`;
}
